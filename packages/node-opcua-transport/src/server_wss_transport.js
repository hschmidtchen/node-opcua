...
ServerWSS_transport.prototype.end = "DEPRECATED";
 
ServerWSS_transport.prototype._abortWithError = function (statusCode, extraErrorDescription, callback) {
...
ServerWSS_transport.prototype._send_ACK_response = function (helloMessage) {
...
ServerWSS_transport.prototype._on_HEL_message = function (data, callback) {
 ...
 *
 *
 *  The ServerWSS_transport initialisation process starts by waiting for the client to send a "HEL" message.
 *
 *  The  ServerWSS_transport replies with a "ACK" message and then start waiting for further messages of any size.
 *
 ...
 *
 */
ServerWSS_transport.prototype.init = function (socket, callback) {

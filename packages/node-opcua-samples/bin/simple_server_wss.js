...
var argv = yargs(process.argv)
    ...
    .string("protocol")
    .describe("protocol","Transport protocol of the server")
    .default("opc.tcp")
    .alias("l","protocol")

    .boolean("reg2discov")
    .default("reg2discov",true)
    .describe("reg2discov","Register to discovery Server")
...
var registerToDiscovery = argv.registerToDiscovery;
...
process.title = "Node OPCUA Server on port : " + server_options.isAuditing;
